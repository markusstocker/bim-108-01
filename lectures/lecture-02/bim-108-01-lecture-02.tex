...
\begin{frame}{Baumstruktur}
	...
	\begin{itemize}
		\item Die Struktur der Elemente eines XML Dokuments ergibt ein Baum
		\item Dokument enthält ein einziges Wurzelelement (\emph{root element})
...
\begin{frame}[fragile]{Baumstruktur und -traversierung}
...
\begin{frame}{Vokabularien in XML}
	...
	\begin{itemize}
		...
		\item Programme A und B können ein Bild als XML speichern
		\item Bedeutet nicht, dass die Bilder austauschbar sind
		\item Austauschbarkeit bedarf gemeinsamer Festlegung auf ein Vokabular
